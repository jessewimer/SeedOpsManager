...
'Check to see if the lot has been retired
    ...
    If Range("QLFRONTLABNUM").value = 0 Then
        MsgBox "Label type missing on seed data page (Label type 1 or 2)"
        GoTo Bottom
    End If
...
PrintLabels:
    ...
    'This is the call to print the back labels
